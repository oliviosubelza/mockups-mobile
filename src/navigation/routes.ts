...
export const routes: RouteInterface[] = [
  ...
  },
  {
    ...
    description: 'Muestreo aleatorio de conteo y control de calidad',
    icon: ShieldAlert,
    showInHome: true,
    showInMenuBottom: true,
    badge: 3,
  ...
  },
  {
    ...
    description: 'Aprobación y consolidación de conteo de transporte',
    icon: ShieldCheck,
    showInHome: true,
    showInMenuBottom: true,
    badge: 2,
  ...
  },
  {
    id: 'despachos',
    path: '/despachos',
    title: 'Revisión de Despacho',
    description: 'Órdenes de transporte asignadas a tu cuenta',
    icon: Truck,
    showInHome: true,
    showInMenuBottom: true,
    badge: 1,
