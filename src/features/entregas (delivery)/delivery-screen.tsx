...
// ==========================================
// MOCK DATA DEL VIAJE ACTIVO Y SUS PARADAS (SANTA CRUZ)
// ==========================================
...
export const DeliveryScreen = () => {
  ...
  // ESTADO PARA DIÁLOGOS PERSONALIZADOS (AppDialog)
  ...
  // Parada activa (ARRIVED o EN_ROUTE o PENDING)
  ...
  // Paradas filtradas por búsqueda y chip
  ...
  return (
    ...
    >
      {/* 1. HEADER ESPACIOSO ORIGINAL CON CONMUTADOR VISTA [LISTA | MAPA] Y PROGRESO DE RUTA */}
      <View
        style={{
      ...
      >
        {/* FILA PRINCIPAL: CÓDIGO DE ORDEN + CONMUTADOR [LISTA | MAPA] A LA DERECHA */}
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          {/* CONMUTADOR DE VISTA [LISTA | MAPA] EN LA ESQUINA SUPERIOR DERECHA */}
          <View
            style={{
              flexDirection: 'row',
        ...
        {/* METRICAS COMPLETAS Y BARRA DE PROGRESO */}
        {viewMode === 'lista' && (
          <>
      ...
      {viewMode === 'mapa' ? (
        ...
        <>
          {/* 2. TARJETA COMPACTA DE LA PARADA DESTACADA CON CARGA EN KILOS Y VOLUMEN (MERCADO MUTUALISTA) */}
          {activeStop && (
            <View
              style={{
                backgroundColor: theme.colors.cardBackground,
            ...
            >
              ...
              {/* BOTONES COMPACTOS DE ACCIÓN RÁPIDA */}
          ...
          {/* 3. BUSCADOR Y FILTROS ESPACIOSOS ORIGINALES */}
          ...
          {/* 4. LISTA DE PARADAS ESPACIOSA MOSTRANDO CARGA EN KILOS Y VOLUMEN */}
          <View style={{ gap: 10 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                {paradasFiltradas.map((stop, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* INFORMACIÓN DE LA PARADA CON CARGA EN KILOS Y VOLUMEN */}
      ...
      {/* DIÁLOGO PERSONALIZADO AppDialog */}
      <AppDialog
